...
public class ListenerDefinition {
    ...
    public void setType(final ListenerType type) {
        switch (type.getValue()) {
            case LEGACY_PLAIN: {
                this.setClassName(LegacyPlainResultFormatter.class.getName());
                this.defaultResultFileSuffix = "txt";
                break;
            }
            case LEGACY_BRIEF: {
                this.setClassName(LegacyBriefResultFormatter.class.getName());
                this.defaultResultFileSuffix = "txt";
                break;
            }
            case LEGACY_XML: {
                this.setClassName(LegacyXmlResultFormatter.class.getName());
